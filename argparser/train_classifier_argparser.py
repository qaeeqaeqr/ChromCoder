...
def argparser():
    ...
    parser.add_argument('--num_workers',      type=int,   metavar='', default=8,          help="Number of workers to be used in dataloader")
    parser.add_argument('--batch_size',       type=int,   metavar='', default=256,        help="Batch Size")
    parser.add_argument('--lr',               type=float, metavar='', default=1e-1,        help="Learning Rate")
    ...
    parser.add_argument('--encoder',          type=str,   metavar='', default="resnet50", help="Which encoder to use (resnet14/18/28/34/41/50/92/101/143/152, wideresnet-depth-width, mobilenetV2)")
    parser.add_argument('--norm',             type=str,   metavar='', default="none",     help="What normalisation layer to use (none, batch, layer)")
    parser.add_argument('--grid_size',        type=int,   metavar='', default=13,          help="Size of the grid of patches that the image is broken down to")
    parser.add_argument('--pred_directions',  type=int,   metavar='', default=1,          help="Number of Directions that was used in CPC training")
    parser.add_argument('--test_interval',    type=int,   metavar='', default=5,          help="Interval of epochs to test at")
    parser.add_argument('--model_num',        type=str,   metavar='', default=300,         help="Number of Epochs that CPC Encoder was trained for",)
    ...
    if args.encoder not in ("resnet14", "resnet18", "resnet28", 
                            ...
                            "resnet92", "resnet101", "resnet143",
                            "resnet152", "mobilenetV2", "vit"
