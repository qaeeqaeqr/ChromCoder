...
def argparser():
    ...
    parser.add_argument('--lr',               type=float, metavar='', default=2e-5,       help="Learning Rate")
    ...
    parser.add_argument('--encoder',          type=str,   metavar='', default="resnet50", help="Which encoder to use (resnet18/34/50/101/152, wideresnet-depth-width, mobilenetV2)")
    parser.add_argument('--norm',             type=str,   metavar='', default="none",     help="What normalisation layer to use (none, batch, layer)")
    parser.add_argument('--grid_size',        type=int,   metavar='', default=13,          help="FIXED!!")
    ...
    if args.encoder not in ("resnet14", "resnet18", "resnet28", 
                            ...
                            "resnet152", "mobilenetV2", "swin", "vit"
